...
export default function EditTransactionPage() {
    ...
    useEffect(() => {
        ...
        Promise.all([
            ...
            txService.getTransactionById(id),
        ]).then(([assets, tx]) => {
                    ...
                    >
                        ...
                        <div>
                            ...
                            {errors.asset_type_id && (
                                <p className={errCls}>{errors.asset_type_id.message}</p>
                            )}
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                />
                                {errors.quantity && (
                                    <p className={errCls}>{errors.quantity.message}</p>
                                )}
                            </div>
                            <div>
                                ...
                                />
                                {errors.unit_price && (
                                    <p className={errCls}>{errors.unit_price.message}</p>
                                )}
                            </div>
                        </div>
